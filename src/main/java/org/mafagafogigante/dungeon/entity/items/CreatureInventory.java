...
public class CreatureInventory extends BaseInventory implements LimitedInventory {
	...
	/**
	 * Attempts to add an Item to this Inventory. As a precondition,
	 * simulateItemAddition should return SUCCESSFUL.
	 *
	...
	/**
	 * Simulates the addition of an Item to this CreatureInventory and returns the
	 * result.
	 *
	 * @param item the Item to be added, not null
	...
	/**
	 * Removes an Item from the CreatureInventory, unequipping it if it is the
	...
	public enum SimulationResult {
		ALREADY_IN_THE_INVENTORY, AMOUNT_LIMIT, WEIGHT_LIMIT, SUCCESSFUL
	}
