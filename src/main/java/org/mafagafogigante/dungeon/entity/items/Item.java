...
public class Item extends Entity {
	...
	/*
	 * The Inventory this Item is in. Should be null whenever this Item is not in an
	 * Inventory.
	 */
	private BaseInventory inventory;

	/**
	 * Constructs a new Item from the provided preset and with the specified
	 * creation date.
	 */
	...
	public enum Tag {
		WEAPON, FOOD, DRINKABLE, CLOCK, BOOK, DECOMPOSES, REPAIRABLE, WEIGHT_PROPORTIONAL_TO_INTEGRITY
	}
